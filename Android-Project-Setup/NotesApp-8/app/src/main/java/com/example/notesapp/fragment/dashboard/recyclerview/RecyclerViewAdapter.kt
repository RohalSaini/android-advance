...
class RecylerViewAdapter(var context: Context, var list: MutableList<TodoData>, val listener: OnClickListener) : RecyclerView.Adapter<com.example.notesapp.fragment.dashboard.recyclerview.RecylerViewAdapter.ViewHolder>(){
